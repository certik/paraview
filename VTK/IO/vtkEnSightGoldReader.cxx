...
vtkCxxRevisionMacro(vtkEnSightGoldReader, "$Revision: 1.57.20.1 $");
  ...
  const char* fileName, int timeStep, vtkMultiBlockDataSet *output)
{
  ...
  geom = ((vtkPolyData*)output->GetDataSet(this->NumberOfGeometryParts, 0));
  ...
  ((vtkPolyData*)output->GetDataSet(this->NumberOfGeometryParts, 0))->
    SetPoints(newPoints);
