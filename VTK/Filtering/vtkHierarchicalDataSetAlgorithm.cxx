...
Module:    $RCSfile: vtkHierarchicalDataSetAlgorithm.cxx,v $
...
vtkCxxRevisionMacro(vtkHierarchicalDataSetAlgorithm, "$Revision: 1.11 $");
...
{
  info->Set(vtkDataObject::DATA_TYPE_NAME(), "vtkHierarchicalDataSet");
  return 1;
}
