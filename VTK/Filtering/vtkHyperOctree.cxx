...
vtkCxxRevisionMacro(vtkHyperOctreeInternal, "$Revision: 1.20 $");
...
// vtkCxxRevisionMacro(vtkCompactHyperOctreeCursor, "$Revision: 1.20 $");
...
void vtkCompactHyperOctreeCursor<D>::CollectRevisions(ostream& sos)
{
  ...
  os << "vtkCompactHyperOctreeCursor<" << D <<"> " << "$Revision: 1.20 $" << '\n';
}
...
//vtkCxxRevisionMacro(vtkCompactHyperOctree, "$Revision: 1.20 $");
...
void vtkCompactHyperOctree<D>::CollectRevisions(ostream& sos)
{
  vtkOStreamWrapper os(sos);
  this->Superclass::CollectRevisions(os);
  os << "vtkCompactHyperOctree<" << D <<"> " << "$Revision: 1.20 $" << '\n';
}
...
vtkCxxRevisionMacro(vtkHyperOctree, "$Revision: 1.20 $");
